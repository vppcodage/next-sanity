...
const JoinOurNewsLetter: React.FC<{ block?: JoinOurNewsLetterType }> = ({
  ...
  return (
    <section className="sidebarNewsletter bg-newsletter-gradient p-[1.875em] rounded-[1em]">
      <div className="[&>div>h6]:text-[#fff] [&>div>h6]:font-DM [&>div>p]:text-[#fff] [&>div>p]:font-semibold [&>div>p]:mb-[0.5em] [&>div>p]:text-[13px] [&>div>h6]:tracking-[-0.66px] [&>div>p]:font-Inter [&>div>p]:opacity-100 [&>div>p]:leading-[153%]">
